export interface Palette {
  ...
  oceanHi: string;
  land: string;
  landLogged: string; // heat-ramp start: a country with one log
  landHot: string; // heat-ramp end: the most-logged countries
  coast: string;
  graticule: string;
  vignette: string;
}
...
export const PALETTES: Record<PaletteName, Palette> = {
  "Sepia Atlas": {
    ...
    ocean: "#C7C09F", oceanHi: "#D8D1B0", land: "#E3D7B8", landLogged: "#D6BC88", landHot: "#8A5A3B", coast: "#A98F66",
  ...
  "Midnight Customs": {
    ...
    ocean: "#1A212D", oceanHi: "#26313F", land: "#37404E", landLogged: "#5C6C88", landHot: "#C79A5B", coast: "#566173",
