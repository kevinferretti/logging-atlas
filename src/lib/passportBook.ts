...
export class PassportBook {
  ...
  buildShell() {
    ...
    b.innerHTML =
      ...
      '<div class="om-page om-left" style="position:absolute;left:0;top:0;width:' + PW + "px;height:" + PH + 'px;border-radius:4px 2px 2px 4px;overflow:hidden;box-shadow:0 1px 3px rgba(0,0,0,.18);backface-visibility:hidden;"></div>' +
